...
Generate a flood of ideas, ruthlessly filter them, then implement the survivors.
...
the project (0-100%). Make sure to actually implement the top ideas now.
```
